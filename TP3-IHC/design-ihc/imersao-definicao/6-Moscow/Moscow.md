...
<div align="center">
  ...
  <p><i>Tabela de priorização de requisitos elaborada com base no método MoSCoW, utilizada para definir o escopo mínimo viável (MVP) do projeto. <br> A classificação permitiu identificar quais funcionalidades são essenciais (“Must Have”), desejáveis (“Should Have”), <br> opcionais (“Could Have”) e quais serão adiadas (“Won’t Have”). Essa análise garantiu uma visão estratégica sobre o que realmente agrega valor ao usuário e deve ser priorizado nas primeiras versões do sistema.</i></p>
</div>
