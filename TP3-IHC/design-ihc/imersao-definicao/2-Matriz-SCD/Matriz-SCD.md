...
| **C7.** Necessidade de um **feed de atualizações de editais** das pró-reitorias. | **S7.** O controle de presença de orientandos é essencial (Must-Have) e pode ser um "check-in" semanal, mais simples que um controle diário. | **D7.** Com que frequência exata o cliente busca por novos editais ? |
