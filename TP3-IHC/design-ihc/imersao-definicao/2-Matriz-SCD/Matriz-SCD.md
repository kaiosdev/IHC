...
| :---: | :---: | :---: |
| **C1.** O usuário principal é o **professor/orientador** (Interface prioritária). | **S1.** Outros professores da UFAM têm a mesma dificuldade de "adaptar" ferramentas genéricas. | **D1.** Para o MVP, qual a prioridade máxima? (Projetos de Pesquisa vs. Extensão? Acompanhamento de projetos existentes vs. feed de novos editais?). |
